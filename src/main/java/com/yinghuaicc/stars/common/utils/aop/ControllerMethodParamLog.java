package com.yinghuaicc.stars.common.utils.aop;
...
public class ControllerMethodParamLog {
    static Logger LOG = LoggerFactory.getLogger(ControllerMethodParamLog.class);
    /**
     * 配置切入点,该方法无方法体,主要为方便同类中其他方法使用此处配置的切入点
     */
    @Pointcut("execution(* com.yinghuaicc.stars.controller..*(..))")
    public void aspect() {
